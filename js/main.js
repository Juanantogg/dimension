...
const mostrarCerrarModales = () => {
  ...
  modalSoy.addEventListener('click', (e) => mostrarModal(e.target, soy, cerrarSoy))
  modalIntereses.addEventListener('click', (e) => mostrarModal(e.target, intereses, cerrarIntereses))
  modalTrabajos.addEventListener('click', (e) => mostrarModal(e.target, trabajos, cerrarTrabajos))
  modalContacto.addEventListener('click', (e) => mostrarModal(e.target, contacto, cerrarContacto))

  cerrarSoy.addEventListener('click', (e) => quitarModal(e.target, soy, modalSoy))
  cerrarIntereses.addEventListener('click', (e) => quitarModal(e.target, intereses, modalIntereses))
  cerrarTrabajos.addEventListener('click', (e) => quitarModal(e.target, trabajos, modalTrabajos))
  cerrarContacto.addEventListener('click', (e) => quitarModal(e.target, contacto, modalContacto))
}
...
const cambiarIconos = () => {
  ...
  if (window.matchMedia('(hover: hover)').matches) {
    ...
    slogan1.addEventListener('mouseover', (e) => cambio("'\\e9d9'", e.target.id))
    slogan1.addEventListener('mouseleave', (e) => cambio("'\\ea0b'", e.target.id))
    slogan2.addEventListener('mouseover', (e) => cambio("'\\e9da'", e.target.id))
    slogan2.addEventListener('mouseleave', (e) => cambio("'\\ea0b'", e.target.id))
